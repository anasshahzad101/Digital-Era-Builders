<footer style="position:relative; z-index:1; border-top:1px solid rgba(255,255,255,.06); background:#07080c;">
  <div style="max-width:1180px; margin:0 auto; padding:clamp(40px,5vw,64px) clamp(20px,5vw,56px); display:flex; flex-wrap:wrap; align-items:center; justify-content:space-between; gap:24px;">
    <div style="font-family:'Space Grotesk',sans-serif; font-weight:700; font-size:18px; letter-spacing:-.02em;">Digital<span style="color:var(--accent);">Era</span> Media</div>
