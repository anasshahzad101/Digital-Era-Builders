...
<style>
  ...
  * { box-sizing:border-box; }
  ...
  /* Statement line beside the founder portrait, stacked on narrow screens */
  .stmt { display:grid; grid-template-columns:1fr auto; gap:clamp(28px,5vw,64px); align-items:center; }
  @media (max-width:820px){ .stmt { grid-template-columns:1fr; } }
    ...
    <section style="max-width:1180px; margin:0 auto; padding:clamp(56px,7vw,96px) clamp(20px,5vw,56px);">
      ...
      <div class="adv2">
        ...
        <div style="display:flex; flex-direction:column; gap:24px;">
          ...
          <div data-reveal style="display:flex; gap:18px; align-items:flex-start;"><div style="font-family:'Space Grotesk',sans-serif; font-weight:700; font-size:15px; color:var(--accent); flex-shrink:0; padding-top:2px;">06</div><div><div style="font-family:'Space Grotesk',sans-serif; font-weight:700; font-size:18px; margin-bottom:8px;">6-month minimum</div><p style="font-size:14.5px; color:#9aa0aa; line-height:1.65; margin:0;">Onboarding alone takes weeks. SEO needs 90 days to move. Six months is the honest floor to build it, prove it, and put revenue in your pocket. Anything less is theater.</p></div></div>
        </div>
      </div>
    </section>
  </div>
