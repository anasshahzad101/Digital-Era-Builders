    ...
    <div class="fit2">
      <div data-reveal class="card" style="border:1px solid rgba(0,229,160,.28); border-radius:16px; background:linear-gradient(180deg, rgba(0,229,160,.05), rgba(255,255,255,.008)); padding:clamp(26px,3vw,34px);">
        ...
        <div style="display:flex; flex-direction:column; gap:12px;">
          ...
          <div style="display:flex; gap:11px; align-items:flex-start;"><span style="color:var(--accent); font-weight:800; font-size:12px; margin-top:3px;">&#10003;</span><span style="font-size:14.5px; color:#c7cbd3; line-height:1.5;">Are ready to invest $3,000+ per month in ad spend</span></div>
